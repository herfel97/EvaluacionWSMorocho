...
a persistence unit "EvaluacionWSMorochoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSMorocho\pom.xml":
...
artifact ("EvaluacionWSMorocho.war") is already built. You can build
